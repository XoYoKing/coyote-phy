...
- (id)initWithDelegate:(id)delegate
{
    ...
    if (self) {
        ...
        _btnPictureArray = [[NSArray alloc]initWithObjects:@"BtnA_1.jpg", @"BtnA_2.jpg", @"BtnB_1.jpg", @"BtnB_2.jpg", @"BtnC_1.jpg", @"BtnC_2.jpg", @"BtnD_1.jpg", @"BtnD_2.jpg", @"BtnE_1.jpg", @"BtnE_2.jpg", @"BtnF_1.jpg", @"BtnF_2.jpg", nil];
        
        for (int i = 0; i < 5; i++) {
            UIButton *btn = [[UIButton alloc]init];
            btn.frame = CGRectMake(86, 271+76*i, 60, 60);
        ...
        //F按钮
        UIButton *btn = [[UIButton alloc]init];
        btn.frame = CGRectMake(657, 400, 50, 50);
        //[btn setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:[_btnPictureArray objectAtIndex:10]]forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage imageNamed:[_btnPictureArray objectAtIndex:11]]forState:UIControlStateHighlighted];
        [btn addTarget:self action:@selector(chooseAnswer:) forControlEvents:UIControlEventTouchUpInside];
        [btn setTag:200+5];
        [self addSubview:btn];
        [btn release];
